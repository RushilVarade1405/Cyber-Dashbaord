export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#020617] via-[#050b1f] to-black text-white px-8 py-24">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="p-6 rounded-xl border border-cyan-400/20 bg-gradient-to-br from-[#0b1224] to-[#0f1a33]">
            <p className="text-gray-300 leading-relaxed mb-4">
              ...
              technologies. This platform reflects real learning experiences,
              practice labs, and concepts explored during hands-on study.
            </p>
        ...
        {/* Footer */}
        <footer className="border-t border-cyan-500/20 pt-6 text-center text-gray-400 text-sm">
          © {new Date().getFullYear()}{" "}
          <span className="text-cyan-400 font-semibold">RYTNIX</span> &{" "}
          <span className="text-cyan-400 font-semibold">CRUSVEDER</span>. All
          rights reserved.
        </footer>
